...
EVIDENCE = [
    ...
    ('a non finite number is never an id', test_rpc.t_a_non_finite_number_is_never_an_id),
    ('a non json constant anywhere invalidates the message', test_rpc.t_a_non_json_constant_anywhere_invalidates_the_message),
    ('a finding never quotes a value', test_rpc.t_a_finding_never_quotes_a_value),
